...
describe ReputationChartService do
  ...
  today = Date.current
  result = [{ percentage: 100.0, reputation: 30, date: today - 3.days },
            { percentage: 0, reputation: 0, date: today - 2.days },
            { percentage: 66.67, reputation: 20, date: today - 1.day },
            { percentage: 33.33, reputation: 10, date: today }]
