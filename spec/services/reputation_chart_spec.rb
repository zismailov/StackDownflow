...
describe ReputationChartService do
  ...
  result = [{ percentage: 100.0, reputation: 30, date: 3.days.ago.to_date },
            { percentage: 0, reputation: 0, date: 2.days.ago.to_date },
            { percentage: 66.67, reputation: 20, date: 1.days.ago.to_date },
            { percentage: 33.33, reputation: 10, date: Date.today }]
