...
RSpec.describe User, type: :model do
  describe "associations" do
    ...
    it { should have_many :reputations }
    it { should have_many :favorite_questions }
  end
  ...
  describe "methods" do
    ...
    describe "#favorite?(questions)" do
      let(:user) { create(:user) }
      ...
      context "when questions is in the user's favorite list" do
        ...
        it "returns true" do
          expect(user.reload.favorite?(question.id)).to eq true
        end
      end
      context "when questions is not in the user's favorite list" do
        it "returns false" do
          expect(user.favorite?(question.id)).to eq false
        end
      end
    end
