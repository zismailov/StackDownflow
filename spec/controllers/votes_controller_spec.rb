...
RSpec.describe VotesController, type: :controller do
  ...
  describe "PATCH #vote_up" do
    let(:patch_vote_up) do
      patch :vote_up, params: { id: comment2 }, format: :json
      comment2.reload
    end
    ...
    context "as an authenticated user" do
      ...
      context "when comment belongs to current user" do
        let(:patch_vote_up) do
          post :vote_up, params: { id: comment }, format: :json
        end
  ...
  describe "GET vote_down" do
    let(:patch_vote_down) do
      patch :vote_down, params: { id: comment2 }, format: :json
      comment2.reload
    end
    ...
    context "as an authenticated user" do
      ...
      context "when comment belongs to current user" do
        let(:patch_vote_down) do
          post :vote_down, params: { id: comment }, format: :json
        end
